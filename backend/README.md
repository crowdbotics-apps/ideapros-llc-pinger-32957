...
## Project Structure
    ...
    ├── ideapros_llc_pinger_32957  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_pinger_32957`
...
2. Clone this repo and `cd ideapros_llc_pinger_32957`
